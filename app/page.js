    ...
    <main className="relative min-h-screen bg-white">
      ...
      <div className="sticky-bottom-bar">
        ...
        <a
          ...
          style={{
            background: activeBar === 'call' ? '#fff' : '#111827',
            color: activeBar === 'call' ? '#111827' : '#fff',
          }}
        >
        ...
        {/* Enquire */}
        <button
          onClick={() => { handleBarClick('enquire'); setIsOpen(true) }}
          className="flex-1 flex flex-col items-center justify-center gap-0.5 !py-2 !px-0 !rounded-none transition-all duration-200"
          style={{
            background: activeBar === 'enquire' ? '#fff' : 'var(--color-teal)',
            color: activeBar === 'enquire' ? 'var(--color-teal)' : '#fff',
            border: 'none',
          }}
        >
        ...
        {/* WhatsApp */}
        <a
          href="https://wa.me/919718344024?text=Hi%20I%20am%20interested%20in%20Godrej%20Kukatpally%20Hyderabad"
          target="_blank" rel="noopener noreferrer"
          onClick={() => handleBarClick('whatsapp')}
          className="flex-1 flex flex-col items-center justify-center gap-0.5 !py-2 !px-0 transition-all duration-200"
          style={{
            background: activeBar === 'whatsapp' ? '#fff' : '#25D366',
            color: activeBar === 'whatsapp' ? '#25D366' : '#fff',
